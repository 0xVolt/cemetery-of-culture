...
int main() {
    ...
    fin = fopen("C:\\Users\\deshi\\Code\\imagine-chetas-coding\\episode-II\\act-II\\data-communication\\data.txt", "r");
    
    // Open file data.txt in append mode - since we want to write to the same file
    fout = fopen
    ("C:\\Users\\deshi\\Code\\imagine-chetas-coding\\episode-II\\act-II\\data-communication\\output.txt", "w");
