/* Code by Desh Iyer */
/* Thankfully you're good enough that attempt0 was good enough to be the actual program */
...
void traverse() {
    ...
    if (head == NULL) {
        ...
        // This loop will reach the node after the last one
        // Thereby covering all the nodes
        while (temp != NULL) {
            temp = temp->next;
        }
    }
